...
export class SessionsController extends ControllerClass<ISession, SessionDto> implements ControllerInterface<ISession, SessionDto> {
  ...
  create(@Meta() meta: Metadata, @Body() data: CreateSessionDto): Observable<SessionDataSerializer> {
  ...
  @UseInterceptors(...WriteInterceptors)
  @SetPolicy(Action.Create, Resource.IdentitySessions)
  createBulk(@Meta() meta: Metadata, @Body() data: CreateSessionItemsDto): Observable<SessionItemsSerializer> {
