...
import { Metric as IMetric, MetricDto } from '@app/common/interfaces/thing';
...
@ApiTags('thing', 'metrics')
@UseFilters(AllExceptionsFilter)
@UseGuards(AuthGuard, ScopeGuard, PolicyGuard)
@UseInterceptors(...GatewayInterceptors, new SentryInterceptor())
export class MetricsController extends ControllerClass<IMetric, MetricDto> implements IController<IMetric, MetricDto> {
  ...
  @ApiResponse({ type: MetricDataSerializer })
  @SetPolicy(Action.Create, Resource.ThingMetrics)
  override create(@Meta() meta: Metadata, @Body() data: CreateMetricDto): Observable<MetricDataSerializer> {
  ...
  @UseInterceptors(...WriteInterceptors)
  @Validation('thing/metrics', 'create')
  @ApiResponse({ type: MetricItemsSerializer })
  @SetPolicy(Action.Create, Resource.ThingMetrics)
  override createBulk(@Meta() meta: Metadata, @Body() data: CreateMetricItemsDto): Observable<MetricItemsSerializer> {
  ...
  override find(@Meta() meta: Metadata, @Filter() filter: FilterDto<IMetric>): Observable<MetricItemsSerializer> {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  @ApiResponse({ status: HttpStatus.OK, type: MetricSerializer })
  Cursor(@Res() res: Response, @Meta() meta: Metadata, @Perm() perm: Permission, @Filter() filter: FilterOneDto<IMetric>) {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  override findOne(@Meta() meta: Metadata, @Filter() filter: FilterOneDto<IMetric>): Observable<MetricDataSerializer> {
  ...
  override deleteOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<IMetric>): Observable<MetricDataSerializer> {
  ...
  @ApiQuery({ type: String, name: 'ref', required: false })
  @UseInterceptors(AuthorityInterceptor, ProjectionInterceptor, ...ResponseInterceptors)
  override restoreOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<IMetric>): Observable<MetricDataSerializer> {
  ...
  override updateBulk(
    @Meta() meta: Metadata,
    @Filter() filter: QueryFilterDto<IMetric>,
    @Body() update: UpdateMetricDto,
  ...
  override updateOne(
    @Meta() meta: Metadata,
    @Filter() filter: FilterOneDto<IMetric>,
    @Body() update: UpdateMetricDto,
