...
export class VehiclesController extends ControllerClass<Vehicle, VehicleDto> implements ControllerInterface<Vehicle, VehicleDto> {
  ...
  create(@Meta() meta: Metadata, @Body() data: CreateVehicleDto): Observable<VehicleDataSerializer> {
  ...
  @UseInterceptors(...WriteInterceptors)
  @SetPolicy(Action.Create, Resource.LogisticVehicles)
  createBulk(@Meta() meta: Metadata, @Body() data: CreateVehicleItemsDto): Observable<VehicleItemsSerializer> {
