...
@ApiTags('career', 'customers')
@UseFilters(AllExceptionsFilter)
@UseGuards(AuthGuard, ScopeGuard, PolicyGuard)
@UseInterceptors(...GatewayInterceptors, new SentryInterceptor())
export class CustomersController extends ControllerClass<Customer, CustomerDto> implements IController<Customer, CustomerDto> {
  ...
  @ApiResponse({ type: CustomerDataSerializer })
  @SetPolicy(Action.Create, Resource.CareerCustomers)
  override create(@Meta() meta: Metadata, @Body() data: CreateCustomerDto): Observable<CustomerDataSerializer> {
  ...
  @UseInterceptors(...WriteInterceptors)
  @Validation('career/customers', 'create')
  @ApiResponse({ type: CustomerItemsSerializer })
  @SetPolicy(Action.Create, Resource.CareerCustomers)
  override createBulk(@Meta() meta: Metadata, @Body() data: CreateCustomerItemsDto): Observable<CustomerItemsSerializer> {
  ...
  override find(@Meta() meta: Metadata, @Filter() filter: FilterDto<Customer>): Observable<CustomerItemsSerializer> {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  @ApiResponse({ status: HttpStatus.OK, type: CustomerSerializer })
  Cursor(@Res() res: Response, @Meta() meta: Metadata, @Perm() perm: Permission, @Filter() filter: FilterOneDto<Customer>) {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  override findOne(@Meta() meta: Metadata, @Filter() filter: FilterOneDto<Customer>): Observable<CustomerDataSerializer> {
  ...
  override deleteOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Customer>): Observable<CustomerDataSerializer> {
  ...
  @ApiQuery({ type: String, name: 'ref', required: false })
  @UseInterceptors(AuthorityInterceptor, ProjectionInterceptor, ...ResponseInterceptors)
  override restoreOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Customer>): Observable<CustomerDataSerializer> {
  ...
  @ApiQuery({ type: String, name: 'ref', required: false })
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  override destroyOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Customer>): Observable<CustomerDataSerializer> {
  ...
  override updateBulk(
    @Meta() meta: Metadata,
    @Filter() filter: QueryFilterDto<Customer>,
    @Body() update: UpdateCustomerDto,
