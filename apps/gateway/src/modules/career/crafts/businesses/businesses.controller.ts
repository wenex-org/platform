...
@ApiTags('career', 'businesses')
@UseFilters(AllExceptionsFilter)
@UseGuards(AuthGuard, ScopeGuard, PolicyGuard)
@UseInterceptors(...GatewayInterceptors, new SentryInterceptor())
export class BusinessesController extends ControllerClass<Business, BusinessDto> implements IController<Business, BusinessDto> {
  ...
  override create(@Meta() meta: Metadata, @Body() data: CreateBusinessDto): Observable<BusinessDataSerializer> {
  ...
  @SetScope(Scope.WriteCareerBusinesses)
  @UseInterceptors(...WriteInterceptors)
  @ApiResponse({ type: BusinessItemsSerializer })
  @SetPolicy(Action.Create, Resource.CareerBusinesses)
  override createBulk(@Meta() meta: Metadata, @Body() data: CreateBusinessItemsDto): Observable<BusinessItemsSerializer> {
  ...
  override find(@Meta() meta: Metadata, @Filter() filter: FilterDto<Business>): Observable<BusinessItemsSerializer> {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  @ApiResponse({ status: HttpStatus.OK, type: BusinessSerializer })
  Cursor(@Res() res: Response, @Meta() meta: Metadata, @Perm() perm: Permission, @Filter() filter: FilterOneDto<Business>) {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  override findOne(@Meta() meta: Metadata, @Filter() filter: FilterOneDto<Business>): Observable<BusinessDataSerializer> {
  ...
  override updateBulk(
    @Meta() meta: Metadata,
    @Filter() filter: QueryFilterDto<Business>,
    @Body() update: UpdateBusinessDto,
