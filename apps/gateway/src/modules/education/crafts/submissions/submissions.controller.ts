  ...
  implements IController<Submission, SubmissionDto>
{
  ...
  @ApiResponse({ type: SubmissionDataSerializer })
  @SetPolicy(Action.Create, Resource.EducationSubmissions)
  override create(@Meta() meta: Metadata, @Body() data: CreateSubmissionDto): Observable<SubmissionDataSerializer> {
  ...
  @Validation('education/submissions', 'create')
  @UseInterceptors(...WriteInterceptors)
  @ApiResponse({ type: SubmissionItemsSerializer })
  @SetPolicy(Action.Create, Resource.EducationSubmissions)
  override createBulk(@Meta() meta: Metadata, @Body() data: CreateSubmissionItemsDto): Observable<SubmissionItemsSerializer> {
  ...
  override find(@Meta() meta: Metadata, @Filter() filter: FilterDto<Submission>): Observable<SubmissionItemsSerializer> {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  @ApiResponse({ status: HttpStatus.OK, type: SubmissionSerializer })
  Cursor(@Res() res: Response, @Meta() meta: Metadata, @Perm() perm: Permission, @Filter() filter: FilterOneDto<Submission>) {
  ...
  @UseInterceptors(AuthorityInterceptor, ...ResponseInterceptors)
  override findOne(@Meta() meta: Metadata, @Filter() filter: FilterOneDto<Submission>): Observable<SubmissionDataSerializer> {
  ...
  override deleteOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Submission>): Observable<SubmissionDataSerializer> {
  ...
  @ApiQuery({ type: String, name: 'ref', required: false })
  @UseInterceptors(AuthorityInterceptor, ProjectionInterceptor, ...ResponseInterceptors)
  override restoreOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Submission>): Observable<SubmissionDataSerializer> {
  ...
  @ApiQuery({ type: String, name: 'ref', required: false })
  @UseInterceptors(AuthorityInterceptor, ProjectionInterceptor, ...ResponseInterceptors)
  override destroyOne(@Meta() meta: Metadata, @Filter() filter: FilterDto<Submission>): Observable<SubmissionDataSerializer> {
  ...
  override updateBulk(
    @Meta() meta: Metadata,
    @Filter() filter: QueryFilterDto<Submission>,
