...
PROTOS[AUTH,3]=./apps/services/domain/src/protobuf/auth.proto
PROTOS[AUTH,4]=./apps/workers/preserver/src/protobuf/auth.proto
PROTOS[AUTH,5]=./libs/common/src/providers/auth/protobuf/auth.proto
