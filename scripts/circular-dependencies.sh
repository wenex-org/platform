...
npm run dpdm:ts ./apps/workers/logger/src/main.ts -- --progress >> circular-dependencies.txt
npm run dpdm:ts ./apps/workers/cleaner/src/main.ts -- --progress >> circular-dependencies.txt
